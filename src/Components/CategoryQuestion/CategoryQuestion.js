...
const CategoryQuestion = ({ question, answer, rating, updateHeight, isOpenQuestion, isOpenCategory, toggleQuestion, setOpenQuestion }) => {
    ...
    useEffect(() => {
        ...
        updateHeight?.();
    }, [updateHeight, isOpenQuestion, isOpenCategory, setOpenQuestion]);
    ...
    return (
        <li className="category-list__item question">
            <div className="question-content">
                ...
                {isOpenQuestion && (
                    <div className="question-content-bottom" ref={answerRef}>
